...
const resourceMonitor = new ResourceMonitorController(store, new ResourceSampler(), overlay)
overlay.setToolbarLayoutListener(() => resourceMonitor.onToolbarLayoutChanged())
