...
export const CH = {
  ...
  /** Native OS menu for recent projects (avoids clipped in-toolbar popovers in packaged builds). */
  projectShowMenu: 'project:showMenu',
  ...
  projectGetContextFolderPath: 'project:getContextFolderPath',
  ...
  promptsPrepareForAgent: 'prompts:prepareForAgent',
  ...
  agentCompanionStagePrompt: 'agentCompanion:stagePrompt',
  agentCompanionConsumeStagedPrompt: 'agentCompanion:consumeStagedPrompt',
...
export const INVOKABLE_CHANNELS: readonly string[] = [
  ...
  CH.projectGetContextFolderPath,
  CH.projectGetAiDocs,
  ...
  CH.agentCompanionStagePrompt,
  CH.agentCompanionConsumeStagedPrompt,
  CH.appQuit,
