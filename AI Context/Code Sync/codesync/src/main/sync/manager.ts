...
import { SyncService, type SyncStartPayload } from './service.js'
...
export class SyncManager {
  ...
  async start(instanceId: string, payload: SyncStartPayload, win: BrowserWindow): Promise<void> {
    ...
    const svc = new SyncService(instanceId)
    await svc.start(payload, win)
