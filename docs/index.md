...
features:
  - title: Cursor Agent (MCP)
    details: A dedicated toolbar menu to enable a localhost MCP server, copy the mcp.json snippet, and let Cursor read your session state directly — no copy-paste, no API keys.
  ...
  - title: Ready Check
    details: A pre-commit trust gate that grades your changes Looks ready, Needs review, or Blocked, with a copyable review brief.
  - title: Session Hub
...
| Connecting Cursor Agent | [MCP server](/features/mcp-server) |
